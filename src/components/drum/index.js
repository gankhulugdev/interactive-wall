    ...
    <div style={{ position: 'absolute', top: y, left: x }}>
      ...
      >
        <defs>
          ...
          <linearGradient id="drumWaveGradient2" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="Teal">
              <animate
                attributeName="stop-color"
                values="Teal; magenta; gold"
                // values="#b7d3fe; #f7c2be; #fdffd8"
                dur="0.32s"
                repeatCount="indefinite"
              />
        ...
        <path
          // fill="#919191"
          fill={isActive ? '#919191' : '#000'}
          // stroke="#7E7E7E"
          stroke={isActive ? '#7E7E7E' : '#000'}
          fillOpacity="0.004"
          strokeOpacity="1.000"
          fillRule="nonzero"
          strokeWidth="49.753044"
        ...
        />{' '}
        <path
          className="onNoffGreen"
          fill={isActive ? 'green' : '#000'}
          stroke={isActive ? 'green' : '#000'}
          fillOpacity="0.988"
          strokeOpacity="1.000"
          fillRule="nonzero"
          strokeWidth="33.226997"
        ...
        />{' '}
        <path
          className="onNoffYellow"
          fill={isActive ? 'yellow' : '#000'}
          // stroke="yellow"
          stroke={isActive ? 'yellow' : '#000'}
          fillOpacity="0.988"
          strokeOpacity="1.000"
          fillRule="nonzero"
          strokeWidth="33.226997"
        ...
        />{' '}
        <path
          className="onNoffBlue"
          fill={isActive ? 'blue' : '#000'}
          stroke={isActive ? 'blue' : '#000'}
          fillOpacity="0.988"
          strokeOpacity="1.000"
          fillRule="nonzero"
          strokeWidth="33.226997"
        ...
        <path
          fill="#000000"
          // stroke="white"
          stroke={isActive ? 'url(#drumWaveGradient2)' : '#000'} //will change later
          fillOpacity="0.000"
          strokeOpacity="1.000"
          fillRule="nonzero"
          strokeWidth="33.226997"
